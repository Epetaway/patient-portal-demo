...
class ValidationFramework {
  ...
  static validators = {
    ...
    match: (otherField, otherValue, message) => {
      return value => {
        return value === otherValue ? null : message || `Must match ${otherField}`;
      };
    },
  };
...
const patientValidationRules = {
  firstName: [ValidationFramework.validators.required],
  email: [ValidationFramework.validators.required, ValidationFramework.validators.email],
  password: [ValidationFramework.validators.required, ValidationFramework.validators.minLength(6)],
  phone: [ValidationFramework.validators.required, ValidationFramework.validators.phone],
};
